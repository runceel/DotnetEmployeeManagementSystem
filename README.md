...
| レイヤー | 行数 | 説明 |
|---------|------|------|
| Domain層 | 1,110 | ビジネスロジック・エンティティ |
| Application層 | 1,077 | ユースケース・サービス |
| Infrastructure層 | 3,455 | データアクセス・外部連携 |
| API層 | 1,596 | Web APIエンドポイント |
