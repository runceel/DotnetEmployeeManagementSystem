...
public static class DbInitializer
{
    ...
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        try
        {
            ...
            // サンプル従業員ID（EmployeeServiceのサンプルデータと合わせる）
            // 実際の従業員IDは実行時に異なる可能性があるため、ここでは仮のGUIDを使用
            var employeeIds = new[]
            {
                Guid.Parse("00000000-0000-0000-0000-000000000001"), // 山田太郎
                Guid.Parse("00000000-0000-0000-0000-000000000002"), // 佐藤花子
                Guid.Parse("00000000-0000-0000-0000-000000000003"), // 田中次郎
                Guid.Parse("00000000-0000-0000-0000-000000000004"), // 鈴木美咲
                Guid.Parse("00000000-0000-0000-0000-000000000005")  // 高橋健太
            };
